...
static uint32_t current_textcolor = 0x00000000;
static uint32_t current_backcolor = 0xFFFFFFFF;
...
{
    *(__IO uint32_t*)(current_framebuffer + 2*((LCD_PIXEL_WIDTH*ypos) + xpos)) = color;
}
