...
#define LCD_COLOR_WHITE          0xFFFFFF     //0xFFFF
#define LCD_COLOR_BLACK          0x000000     //0x0000
#define LCD_COLOR_GREY           0xBEBEBE     //0xF7DE
#define LCD_COLOR_BLUE           0x0000FF     //0x001F
#define LCD_COLOR_BLUE2          0x4169E1     //0x051F
#define LCD_COLOR_RED            0xFF0000     //0xF800
#define LCD_COLOR_MAGENTA        0xFF00FF     //0xF81F
#define LCD_COLOR_GREEN          0x00FF00     //0x07E0
#define LCD_COLOR_CYAN           0x00FFFF     //0x7FFF
#define LCD_COLOR_YELLOW         0xFFFF00     //0xFFE0
...
#define VerticalScreen      0    /* NOT USED IN GD32F450I */
...
uint32_t lcd_text_color_get(void);
/* set the background color */
void lcd_background_color_set(uint32_t color);
/* get the current background color */
uint32_t lcd_background_color_get(void);
