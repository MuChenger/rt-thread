...
# GCC
    ...
    LFLAGS = DEVICE + ' --scatter "board\linker_scripts\link.sct stm32n657xx_axisram2_fsbl.sct" --info sizes --info totals --info unused --info veneers --list rtthread.map --strict'
